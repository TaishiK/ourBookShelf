...
pub fn v1(endpoint: &str) -> String {//v1のエンドポイントを作成
    format!("/api/v1{}", endpoint)
}

pub fn make_router(registry: MockAppRegistryExt) -> Router {//ルーターを作成
    Router::new()
        .merge(v1::routes())
        .merge(auth::routes())
...
#[fixture]
pub fn fixture_registry() -> MockAppRegistryExt {//fixture_registryを作成
    MockAppRegistryExt::new()
}

#[fixture]
pub fn fixture_auth(mut fixture_registry: MockAppRegistryExt) -> MockAppRegistryExt {//fixture_authを作成
